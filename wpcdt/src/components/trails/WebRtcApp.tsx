...
//   const bandwidthSelectorRef = useRef<HTMLSelectElement | null>(null);
//   const syntheticRef = useRef<HTMLInputElement | null>(null);
...
//   const [bitrateGraph, setBitrateGraph] = useState<TimelineGraphView | null>(
//     null
//   );
//   const [bitrateSeries, setBitrateSeries] = useState<TimelineDataSeries | null>(
//     null
//   );
//   const [headerrateSeries, setHeaderrateSeries] =
//     useState<TimelineDataSeries | null>(null);
//   const [packetGraph, setPacketGraph] = useState<TimelineGraphView | null>(
//     null
//   );
//   const [packetSeries, setPacketSeries] = useState<TimelineDataSeries | null>(
//     null
//   );
//   const [lastResult, setLastResult] = useState<Map<
//     string,
//     RTCStatsReport
//   > | null>(null);
//   const [lastRemoteStart, setLastRemoteStart] = useState(0);
//   const [lastRemoteFullSizeDelay, setLastRemoteFullSizeDelay] = useState(0);
//   useEffect(() => {
//     const remoteVideo = remoteVideoRef.current;
//     const localVideo = localVideoRef.current;
//     const callButton = callButtonRef.current;
//     const hangupButton = hangupButtonRef.current;
//     const bandwidthSelector = bandwidthSelectorRef.current;
...
//       );
//       if (
//         localVideo.videoWidth == remoteVideo.videoWidth &&
...
//       }
//       // Fallback to the SDP changes with local renegotiation as a way of limiting
//       // the bandwidth.
//       return pc1
//         .createOffer()
...
//               const headerrate =
//                 (8 *
//                   (headerBytes - lastResult.get(report.id).headerBytesSent)) /
//                 (now - lastResult.get(report.id).timestamp);
...
//               // calculate the number of packets and append to the chart
...
//       <button ref={callButtonRef} id="callButton">
//         Call
//       </button>
//       <button ref={hangupButtonRef} id="hangupButton" disabled>
//         Hang Up
//       </button>
//       <select ref={bandwidthSelectorRef} id="bandwidth" disabled>
//         <option value="unlimited">Unlimited</option>
//         <option value="256">256 Kbps</option>
//         <option value="512">512 Kbps</option>
//         <option value="1024">1 Mbps</option>
//       </select>
//       <input ref={syntheticRef} id="synthetic" type="checkbox" /> Synthetic
//     </div>
//   );
// };
